		...
		methods: {
			...
			initData() {
				...
				for(let i=0;i<this.skuslist.length;i++){
					...
					if(this.skuslist[i].level==1){
						level_1.push(this.skuslist[i])
					}else if(this.skuslist[i].level==2){
						level_2.push(this.skuslist[i])
					}else if(this.skuslist[i].level==4){
						level_4.push(this.skuslist[i])
					}else if(this.skuslist[i].level==5){
						level_5.push(this.skuslist[i])
					}
				}
				...
				this.skus=this.skus.sort(this.randomSort);
				
				for(let i=0;i<this.skus.length;i++){
					for(let n=0;n<this.levelskus.length;n++){
						if(this.levelskus[n].level==this.skus[i].level){
							this.skus[i].level_icon=this.levelskus[n].icon
							this.skus[i].level_title=this.levelskus[n].title
						}
					}
				}
