	...
	<view class="container">
		...
		<view class="list">
			<view class="item" v-for="(item, index) in list" @tap="submitBuy(item)" hover-class="hover">
				<view class="score">
					<text style="font-weight: bold;">{{item.redpack / 100}}</text><span class="score-text">元</span>
				</view>
				<view class="money">
		...
		<view style="margin-top: 20rpx; text-align: left;font-size: 24rpx;color: red;"><text>注意：充值不能退款,不能提现</text></view>
