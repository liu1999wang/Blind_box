<template>
	<view class="coupon-item global-shadow margin-v" :class="active?'active':'unactive'" @tap="click">
		...
		<view class="action">
			<view class="btn" @tap="toUse" v-if="active">
				{{activeText}}
			</view>
...
<script>
	...
	export default {
		...
		methods: {
			toUse() {
				if (this.baseCoupon.to_use_link && this.baseCoupon.to_use_link.type != 'none' ) {
